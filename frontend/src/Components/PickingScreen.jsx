...
const PickingScreen = () => {
  ...
  return (
    <div className="picking-screen">
      <Link to={`/sessions/preparation/${session}`} className="back-link">Retour vers la liste des sessions</Link>
      ...
      <div className="variant-details" style={{ color: variantIsProblematic ? 'red' : 'inherit' }}>
